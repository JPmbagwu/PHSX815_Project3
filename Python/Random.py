...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr  2 19:28:29 2023
...
class Random:
    ...
    def Categorical(self, p1=0.35,p2=0.35, p3=0.35, p4=0.35,p5=0.35, p6=0.35):
        if p1 < 0. or p1 > 1.:
            return 1
        if p2 < 0. or p2 > 1.:
            return 2            
        ...
        if p1 + p2  < R < p1 + p2 + p3:
            return 3
        if p1 + p2  < R < p1 + p2 + p3 + p4:
            return 4
        if p1 + p2  < R < p1 + p2 + p3 + p4 + p5:
            return 5
        if p1 + p2  < R < p1 + p2 + p3 + p4 + p5 + p6:
            return 6
        else:
            return
